...
class QueryGenerator:
    ...
    def __init__(self, llm, model_kwargs: Dict[str, any] = None) -> None:
        """
        Initializes the QueryGenerator with a language model and optional model arguments.
        """
        self.llm = llm

    def generate_queries(self, corpus: Dict[str, str], num_questions_per_chunk: int = 2, verbose: bool = False) -> Tuple[Dict[str, str], Dict[str, List[str]]]:
        """
...
def save_dict_safely(data: Dict, file_path: str) -> None:
    """
...
def main() -> None:
    ...
    parser.add_argument("--data_directory", type=str, default="./sample_data/embed_tuning/datasheets", help="Directory containing PDF files.")
    parser.add_argument("--train_corpus_output_path", type=str, default='./data/train_corpus.json', help="Output path for the training corpus.")
    parser.add_argument("--val_corpus_output_path", type=str, default='./data/val_corpus.json', help="Output path for the validation corpus.")
    parser.add_argument("--train_output_path", type=str, default="./data/train_dataset.json", help="Output path for the training dataset.")
    parser.add_argument("--val_output_path", type=str, default="./data/val_dataset.json", help="Output path for the validation dataset.")
