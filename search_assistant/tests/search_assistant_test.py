...
Test cases:
    ...
    test_basic_call: tests the 'search and answer' functionality of the kit, verifying that both the LLM answer and sources exist and are not empty
    test_retrieval_call: tests the 'search and scrape sites' functionality of the kit, verifying that both the LLM answer and source_documents exist and are not empty
