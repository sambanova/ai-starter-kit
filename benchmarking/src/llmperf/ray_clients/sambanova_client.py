...
class SambaNovaLLMClient(LLMClient):
    ...
    def _get_url(self, request_config, base_url, project_id, endpoint_id):
        if request_config.mode == "stream":
    ...
    def _get_total_request_time(self, url, headers, data, stream):
    ...
    def populate_server_metrics(self, output_data, metrics):
        ...
        metrics[common_metrics.TOTAL_TOKEN_THROUGHPUT_SERVER] = output_data["result"][
            "responses"
        ][0].get("total_tokens_per_sec")
        return metrics
