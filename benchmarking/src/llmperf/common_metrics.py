...
NUM_REASONING_TOKENS_SERVER = 'server_number_reasoning_tokens'
NUM_CACHED_TOKENS_SERVER = 'server_number_cached_tokens'
NUM_CACHE_CREATION_TOKENS_SERVER = 'server_number_cache_creation_tokens'
