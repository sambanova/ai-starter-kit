...
```
2. Update API information for the SambaNova LLM.  These are represented as configurable variables in the environment variables file in ai-starter-kit/.env. For example, an endpoint with the URL
