...
def plot_diarization(audio_path, transcript, dark_mode =True):
    ...
    for index, row in transcript.iterrows():
        ...
        plt.plot(time[start_index:end_index:10], signal[start_index:end_index:10], color=speaker_colors[speaker], linewidth=0.07, label=speaker)
...
def plot_diarization_plotly(audio_path, transcript):
    
    color_scheme = ['rgb(31, 119, 180)', 'rgb(214, 39, 40)', 'rgb(255, 127, 14)', 'rgb(44, 160, 44)',  
    ...
    layout = go.Layout(
        title='Diarized Audio Signal Waveform',
    ...
    fig = go.Figure(go.Indicator(
        ...
        gauge = {
            ...
            'steps' : [
                ...
                {'range': [80, 100], 'color': "#99cc66"}],  # Soft green color
            'threshold' : {
