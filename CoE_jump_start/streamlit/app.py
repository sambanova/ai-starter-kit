...
from CoE_jump_start.src.use_CoE_model import get_expert, get_expert_val, get_llm, run_e2e_vector_database, run_bulk_routing_eval, run_simple_llm_invoke
...
def main():
    ...
    page = st.sidebar.selectbox("Choose a page", ["Config", "Expert", "Simple", "E2E With Vector DB", "Bulk Evaluation"])
