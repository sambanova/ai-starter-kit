...
from src.edu_flow.config import LLM_CONFIG, LLM_CONFIGS, AVAILABLE_MODELS, DEFAULT_PROVIDER, DEFAULT_MODEL, PROVIDER_CONFIGS
...
def main():
    ...
    # Page config
    st.set_page_config(
        page_title="SambaNova Research Agent",
        page_icon="🤖",
        layout="wide",
