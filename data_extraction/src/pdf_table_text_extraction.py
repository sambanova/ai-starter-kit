...
def extract_elements_from_file(input_file, output_image_dir):
    """
...
def process_json_file(input_json_filename, output_file):
    """
...
def process_elements(elements, output_file):
    """
    Processes a JSON file and write the extracted elements (text, tables) in the specified plain text file.
...
def main(input_file, output_file, output_image_dir):
