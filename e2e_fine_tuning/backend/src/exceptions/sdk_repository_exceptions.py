...
class AppFetchError(SnsdkWrapperRepositoryrError):
    ...
    def __init__(self, message: str = 'Error fetching available apps.', *args):
        super().__init__(message, *args)
...
class DatasetFetchError(SnsdkWrapperRepositoryrError):
    ...
    def __init__(self, message: str = 'Error fetching datasets.', *args):
        super().__init__(message, *args)
...
class DatasetCreateError(SnsdkWrapperRepositoryrError):
    ...
    def __init__(self, dataset_name: str, message: str = 'Error creating dataset.', *args):
        super().__init__(message, *args)
...
class DatasetDeleteError(SnsdkWrapperRepositoryrError):
    ...
    def __init__(self, dataset_name: str, message: str = 'Error deleting dataset.', *args):
        super().__init__(message, *args)
        self.dataset_name = dataset_name
