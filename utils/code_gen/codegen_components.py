...
class CodeGenComponents(BaseComponents):
    ...
    def init_code_router(self) -> None:
        ...
        code_router_prompt: Any = load_prompt(kit_dir + self.prompts_paths["code_router_prompt"]) 
    ...
    def init_codegen_chain(self) -> None:
        ...
        codegen_prompt: Any = load_prompt(kit_dir + self.prompts_paths["codegen_prompt"]) 
    ...
    def init_codegen_qc_chain(self) -> None:
        ...
        codegen_qc_prompt: Any = load_prompt(kit_dir + self.prompts_paths["codegen_qc_prompt"]) 
    ...
    def init_refactor_chain(self) -> None:
        ...
        refactor_prompt: Any = load_prompt(kit_dir + self.prompts_paths["refactor_prompt"]) 
