...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        '--sleep-duration', type=int, default=10, help='Sleep duration between requests in seconds (default: 10)'
    )
...
def run_connection_pooling_test(
    api_url: str, api_key: str, model: str, test_duration: int, sleep_duration: int, max_tokens: int, prompt: str
) -> dict:
    """
